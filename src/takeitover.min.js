...
n.contentSelector
t(document).on("click",n.elementSelector,function(){var e=t(this),o=e.attr("data-target")
null==o?(o=n.contentSelector,o=e.next(o)):o=t(o),t("body").css({"overflow-y":"hidden",height:"100%"}),t(".takeitover-overlay").show().animate({opacity:1},n.speed),setTimeout(function(){1==n.closeButton&&t(".takeitover-closebtn").show().animate({opacity:1},n.speed/2),o.show(),o.animate({top:"0px",opacity:1},n.speed/2,i,function(){t.isFunction(n.callback)&&n.callback.call(this)})},n.speed/2)})
var a
