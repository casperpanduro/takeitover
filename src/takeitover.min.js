...
e.removeClass("active"),n.removeClass("active"),e.animate({top:"100px",opacity:0},a.speed/2,function(){t(this).hide()}),t(".takeitover-closebtn").animate({opacity:0},a.speed/2,function(){t(this).hide()}),setTimeout(function(){t("body").css({"overflow-y":"scroll",height:"auto"}),e.next(a.contentSelector).show(),t(".takeitover-overlay").animate({opacity:0},a.speed,function(){t(this).hide()})},a.speed/2)}t("body.takeitover-noscroll").css({"overflow-y":"hidden",height:"100%"})
...
var i
i=0==a.easing?"":a.easing
a.contentSelector
t(this).on("click",function(e){t.isFunction(a.before)&&a.before.call(this)
var o=t(this)
o.addClass("active")
var n=o.attr("data-target")
null==n?(n=a.contentSelector,n=o.next(n)):n=t(n),n.addClass("active"),t("body").css({"overflow-y":"hidden",height:"100%"}),t(".takeitover-overlay").show().animate({opacity:1},a.speed),setTimeout(function(){1==a.closeButton&&t(".takeitover-closebtn").show().animate({opacity:1},a.speed/2),n.show(),n.animate({top:"0px",opacity:1},a.speed/2,i,function(){t.isFunction(a.callback)&&a.callback.call(this)})},a.speed/2),e.preventDefault()})
var s
return 1==a.clickOnOverlay&&(s=a.contentSelector,t(s).click(function(t){t.target!==this||o()})),1==a.closeButton&&t(document).on("click",".takeitover-closebtn",function(){o()}),this}}(jQuery)
