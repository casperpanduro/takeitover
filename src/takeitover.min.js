...
var i=!1
a.contentSelector
0==i&&t(this).on("click",function(e){i=!0,t.isFunction(a.before)&&a.before.call(this)
var o=t(this)
o.addClass("active")
var n=o.attr("data-target")
null==n?(n=a.contentSelector,n=o.next(n)):n=t(n),n.addClass("active"),t("body").css({"overflow-y":"hidden",height:"100%"}),t(".takeitover-overlay").show().animate({opacity:1},a.speed),setTimeout(function(){1==a.closeButton&&t(".takeitover-closebtn").show().animate({opacity:1},a.speed/2),n.show(),n.animate({top:"0px",opacity:1},a.speed/2,s,function(){t.isFunction(a.callback)&&a.callback.call(this)})},a.speed/2),e.preventDefault()})
var c
